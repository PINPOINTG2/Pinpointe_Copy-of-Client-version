...
public class UpdateSubscribers extends BaseClass{
	...
	RequestDataForUpdateSubscriber request_xml = new RequestDataForUpdateSubscriber();
	...
	public void updateSubscribers() {
		...
		ArrayList<String[]> tdata_array = data.getupdateSubscriberData();
		ArrayList<String[]> tdata_forfields = data.getCustomeFieldDataforUpdateSubscriber();
		String[] tdata = tdata_array.get(2);
