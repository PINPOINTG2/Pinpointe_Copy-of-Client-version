...
public class AddMultipleSubscribers extends BaseClass{
	...
	@Test(testName = "Post Add Multiple Subscriber", dataProviderClass=TestData.class, dataProvider="getaddmultipleSubscribers")
	public void apicall(String[] body) {
		...
		ArrayList<String[]> contact = data.getContactforAddMultipleSubscribers();

		ArrayList<String[]> customField = data.getCustomeFieldforAddMultipleSubscriber();
