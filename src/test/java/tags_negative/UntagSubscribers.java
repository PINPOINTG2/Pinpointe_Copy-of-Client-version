...
import validation.UntagSubscribersValidation;
...
public class UntagSubscribers extends BaseClass {
	...
	UntagSubscribersValidation validation = new UntagSubscribersValidation();

	@Test(testName = "Untag Subscribers", dataProviderClass=TestData.class, dataProvider="gettags_Negative_untagSubscribers")
	public void untagSubscribers(String[] body) {
