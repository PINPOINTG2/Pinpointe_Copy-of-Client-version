...
import tags_common_utilities.RequestDataforTagSubscribers;
import tags_common_utilities.RequestDataforUntagSubscribers;
import validation.TagSubscribersValidation;

public class TagSubscribers extends BaseClass {

	String methodName = "Tag Subscribers";
	String responseCode = "";
	String responseTime = "";
	String api_version ="";
	String status = "";
	...
	RequestDataforTagSubscribers request_xml = new RequestDataforTagSubscribers();
	TagSubscribersValidation validation = new TagSubscribersValidation();

	@Test(testName = "Tag Subscribers", dataProviderClass=TestData.class, dataProvider="gettags_Negative_TagSubscribers")
	public void tagSubscribers(String[] body) {
