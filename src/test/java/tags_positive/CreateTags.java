...
public class CreateTags extends BaseClass {
	...
	public void createTags() {
		ArrayList<String[]> tdata_array = data.getCreateTagsData();
		...
		String request_para = request_xml.requestdata(tdata_array);	
	...
	public HashMap<String, String> parseResponse(Response response) {
		...
		try {
			...
			if(status.toLowerCase().trim().contains("success") ) {
				...
				Element ele_errors = null;
				try {
					ele_errors= ele_data.getChild("errors");
				}
				catch(Exception e) {
