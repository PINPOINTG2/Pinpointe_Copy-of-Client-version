...
public class RequestDataForAddSubscriber extends BaseClass {
	...
	public String requestdata(String[] body, ArrayList<String[]> fielddata) {
		...
		builder.append("<requestmethod>AddSubscriberToList</requestmethod>");
		...
		String[] tags = body[7].trim().toString().replace("\"", "").split("&"); 
		for (String tag : tags) {
