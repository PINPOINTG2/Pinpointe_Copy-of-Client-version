...
public class CheckListforUnsubscribedContactValidation extends BaseClass {
	...
	public boolean parameter_Validation(String paraString, HashMap<String, String> error) {
		...
		String emailaddress_ismandatory = utils.getproperty("mandatoryfield", "CheckListForUnsubscribers_email").trim();
		String mailinglist_ismandatory = utils.getproperty("mandatoryfield", "CheckListForUnsubscribers_list").trim();
		...
		try {
			...
			Element  ele_mailinglist = ele_details.getChild("listId");
