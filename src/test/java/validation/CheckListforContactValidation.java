...
public class CheckListforContactValidation extends BaseClass{
	...
	public boolean parameter_Validation(String paraString, HashMap<String, String> error) {
		...
		String emailaddress_ismandatory = utils.getproperty("mandatoryfield", "CheckListForContact_Subscribers_email").trim();
		String mailinglist_ismandatory = utils.getproperty("mandatoryfield", "CheckListForContact_Subscribers_list").trim();
		...
		try {
			...
			Element  ele_emailaddress = ele_details.getChild("Email");
